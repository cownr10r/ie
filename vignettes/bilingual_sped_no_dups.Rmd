---
title: "bilingual sped keeping only those rows"
...
GOAL: get file with all people, no dups. AND bilinguals and SPEDS without duplicating core rows
1.	grab bilingual rows with grepl
2.	Then take out bilingual rows from original dataframe (call it orig) to make generic data frame without bilingual. Now there are 2 data frames (orig + bilin).
...
The file starts from a finisher file that has been downloaded from ecos as finisher file.

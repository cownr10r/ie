---
title: "Bulk GPA as a Process"
author: "Dr. Mario Martinez"
date: "4/11/2022"
...
First Objective: determine if transfer credits verify out to the transfer credits taken on the books. Be sure to 
...
Now that the first process is complete, Get the PSIDs to process the rest of the GPA for the verified transfer hour cases.
...
verified1 <- this[grepl("0", this$yes),] %>%
  ...
  head(verified1)
```
From here, put the PSIDs into peoplesoft. Retrieve from Sharepoint folder
...
Content GPA below. This will depend on the certificate. Below we give for generalist EC-6
